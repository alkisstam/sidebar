...
class SidebarModule(private val reactContext: ReactApplicationContext) :
    ...
    fun getPillSettings(promise: Promise) {
        ...
        map.putInt("width", prefs.getInt(Prefs.PILL_WIDTH, 10))
        ...
        val savedThemeChoice = prefs.getString(Prefs.THEME_CHOICE, null)
            ?: prefs.getString(Prefs.PILL_THEME, null) ?: "system"
    ...
    fun getOverlaySettings(promise: Promise) {
        ...
        map.putBoolean("showRecentApps", prefs.getBoolean(Prefs.SHOW_RECENT_APPS, false))
        map.putBoolean("showKeyboardOnAllApps", prefs.getBoolean(Prefs.SHOW_KEYBOARD_ON_ALL_APPS, false))
    ...
    fun saveOverlaySettings(settings: ReadableMap, promise: Promise) {
        ...
        if (settings.hasKey("showRecentApps")) prefs.putBoolean(Prefs.SHOW_RECENT_APPS, settings.getBoolean("showRecentApps"))
        if (settings.hasKey("showKeyboardOnAllApps")) prefs.putBoolean(Prefs.SHOW_KEYBOARD_ON_ALL_APPS, settings.getBoolean("showKeyboardOnAllApps"))
